...
class Auth implements InputFilterAwareInterface
{
    ...
    public function exchangeArray($data) 
    {
        ...
        $this->usr_full_name = (!empty($data['usr_full_name'])) ? $data['usr_full_name'] : null;
        ...
        $this->raw_password = (!empty($data['raw_password'])) ? $data['raw_password'] : null;
        $this->bypass_token = (!empty($data['bypass_token'])) ? $data['bypass_token'] : null;
        $this->id_shift = (!empty($data['id_shift'])) ? $data['id_shift'] : null;
